...
Go to the [Umami official website](https://umami.is/) to register an account and select the **analytics node region** â†?add your website in [Websites](https://cloud.umami.is/settings/websites) â†?click **Edit** next to your website and then find **ShareURL** at the top and turn on the switch to get the following content:
